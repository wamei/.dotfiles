...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (yascroll wgrep-ag web-mode visual-regexp-steroids undo-tree tide string-inflection ssass-mode skewer-mode session rotate robe rbenv rainbow-mode quickrun popwin phi-search-migemo pcmpl-git orglink org-octopress mwim multiple-cursors mozc-popup math-symbol-lists markdown-mode magit mag-menu log4e list-processes+ hydra hl-line+ helm-swoop helm-projectile helm-package helm-migemo helm-git-grep helm-descbinds helm-ag-r helm-ag go-eldoc git-gutter-fringe flycheck-pos-tip expand-region exec-path-from-shell elscreen-separate-buffer-list elscreen-multi-term edit-indirect dockerfile-mode docker-compose-mode docker dired-toggle-sudo dired-subtree dired-rainbow company-web company-tern company-statistics company-php company-inf-ruby coffee-mode bracketed-paste ag ac-php)))
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((((class color) (min-colors 89) (type tty)) (:foreground "#e1e1e0")) (((class color) (min-colors 89)) (:background "#1e1e1e" :foreground "#e1e1e0"))))
 '(button ((((class color) (min-colors 89)) (:underline t))))
 '(cursor ((((class color) (min-colors 89)) (:background "#a4a4a4"))))
 '(diff-added ((((class color) (min-colors 89)) (:foreground "#33aa33" :background nil))))
 '(diff-context ((((class color) (min-colors 89)) (:foreground "#eeeeee" :background nil))))
 '(diff-file-header ((((class color) (min-colors 89)) (:foreground "#eeeeee" :background "#222222"))))
 '(diff-header ((((class color) (min-colors 89)) (:foreground "#eeeeee" :background "#555555"))))
 '(diff-refine-added ((((class color) (min-colors 89)) (:foreground "#00f900" :background nil))))
 '(diff-refine-removed ((((class color) (min-colors 89)) (:foreground "#ff2600" :background nil))))
 '(diff-removed ((((class color) (min-colors 89)) (:foreground "#aa2600" :background nil))))
 '(elscreen-tab-background-face ((((class color) (min-colors 89)) (:background "#2e2e2e"))))
 '(elscreen-tab-current-screen-face ((((class color) (min-colors 89)) (:foreground "#eab700" :background "#1e1e1e"))))
 '(elscreen-tab-other-screen-face ((((class color) (min-colors 89)) (:foreground "#888888" :background "#2e2e2e"))))
 ...
 '(font-lock-constant-face ((((class color) (min-colors 89)) (:foreground "#729fcf"))))
 ...
 '(fringe ((((class color) (min-colors 89)) (:background "#2e2e2e"))))
 '(git-gutter-fr:added ((((class color) (min-colors 89)) (:foreground "#00f900" :background "#2e2e2e"))))
 '(git-gutter-fr:deleted ((((class color) (min-colors 89)) (:foreground "#aa2600" :background "#2e2e2e"))))
 '(git-gutter-fr:modified ((((class color) (min-colors 89)) (:foreground "#ed74cd" :background "#2e2e2e"))))
 '(git-gutter:added ((((class color) (min-colors 89)) (:foreground "#00f900" :background "#2e2e2e"))))
 '(git-gutter:deleted ((((class color) (min-colors 89)) (:foreground "#aa2600" :background "#2e2e2e"))))
 '(git-gutter:modified ((((class color) (min-colors 89)) (:foreground "#ed74cd" :background "#2e2e2e"))))
 ...
 '(header-line ((((class color) (min-colors 89)) (:background "#2e2e2e" :foreground "#eeeeec"))))
 '(helm-buffer-directory ((((class color) (min-colors 89)) (:foreground "#eeeeec" :background "#4271ae"))))
 '(helm-ff-directory ((((class color) (min-colors 89)) (:foreground "#23d7d7"))))
 '(helm-ff-file ((((class color) (min-colors 89)) (:foreground "#eeeeee"))))
 '(helm-ff-symlink ((((class color) (min-colors 89)) (:foreground "#ed74cd"))))
 '(helm-selection ((((class color) (min-colors 89)) (:background "#035f56"))))
 '(highlight ((((class color) (min-colors 89)) (:background "#035f56"))))
 '(isearch ((((class color) (min-colors 89)) (:background "#fcffad" :foreground "#000000"))))
 '(lazy-highlight ((((class color) (min-colors 89)) (:background "#ff4242"))))
 ...
 '(linum ((((class color) (min-colors 89)) (:height 0.8 :background "#2e2e2e"))))
 '(magit-branch ((((class color) (min-colors 89)) (:foreground "#34cae2" :background nil))))
 '(magit-hash ((((class color) (min-colors 89)) (:foreground "#dbdb95" :background nil))))
 '(magit-item-highlight ((((class color) (min-colors 89)) (:background "#000000"))))
 '(magit-log-sha1 ((((class color) (min-colors 89)) (:foreground "#ff4242" :background nil))))
 ...
 '(mode-line ((((class color) (min-colors 89)) (:background "#0B2087" :foreground "#eeeeec"))))
 '(mode-line-80col-face ((((class color) (min-colors 89)) (:inherit mode-line-position-face :foreground "black" :background "#eab700"))) t)
 '(mode-line-delim-face-1 ((((class color) (min-colors 89)) (:inherit mode-line-face :foreground "white"))) t)
 '(mode-line-filename-face ((((class color) (min-colors 89)) (:inherit mode-line-face :foreground "#eab700" :weight bold))) t)
 '(mode-line-folder-face ((((class color) (min-colors 89)) (:inherit mode-line-face :weight extra-light :height 0.8 :foreground "#e5e5e5"))) t)
 '(mode-line-git-face ((((class color) (min-colors 89)) (:inherit mode-line-face :foreground "green"))) t)
 '(mode-line-inactive ((((class color) (min-colors 89)) (:background "#878787" :foreground "#eeeeec"))))
 '(mode-line-minor-mode-face ((((class color) (min-colors 89)) (:inherit mode-line-face :weight extra-light :height 0.8 :foreground "#cccccc"))) t)
 '(mode-line-mode-face ((((class color) (min-colors 89)) (:inherit mode-line-face :foreground "#eeeeec"))) t)
 '(mode-line-modified-face ((((class color) (min-colors 89)) (:inherit mode-line-face :foreground "#c82829" :background "#ffffff"))) t)
 '(mode-line-name ((((class color) (min-colors 89)) (:foreground "#ed74cd"))))
 '(mode-line-name-face ((((class color) (min-colors 89)) (:inherit mode-line-face :foreground "#ed74cd"))) t)
 '(mode-line-position-face ((((class color) (min-colors 89)) (:inherit mode-line-face))) t)
 '(mode-line-process-face ((((class color) (min-colors 89)) (:inherit mode-line-face :foreground "green"))) t)
 '(mode-line-projectile-face ((((class color) (min-colors 89)) (:inherit mode-line-face :foreground "green"))) t)
 '(mode-line-read-only-face ((((class color) (min-colors 89)) (:inherit mode-line-face :foreground "#4271ae"))) t)
 '(mode-line-time-face ((((class color) (min-colors 89)) (:inherit mode-line-face :foreground "#ed74cd"))) t)
 '(region ((((class color) (min-colors 89)) (:background "#98514B" :foreground "#878787"))))
 '(term-color-black ((((class color) (min-colors 89)) (:foreground "#000000" :background "#000000"))))
 '(term-color-blue ((((class color) (min-colors 89)) (:foreground "#598eff" :background "#598eff"))))
 '(term-color-cyan ((((class color) (min-colors 89)) (:foreground "#00fcff" :background "#00fcff"))))
 '(term-color-green ((((class color) (min-colors 89)) (:foreground "#00f900" :background "#00f900"))))
 '(term-color-magenta ((((class color) (min-colors 89)) (:foreground "#ff40ff" :background "#ff40ff"))))
 '(term-color-red ((((class color) (min-colors 89)) (:foreground "#ff2600" :background "#ff2600"))))
 '(term-color-white ((((class color) (min-colors 89)) (:foreground "#eeeeee" :background "#eeeeee"))))
 '(term-color-yellow ((((class color) (min-colors 89)) (:foreground "#fefb00" :background "#fefb00"))))
 '(term-default-bg-color ((((class color) (min-colors 89)) (:inherit term-color-black))))
 '(term-default-fg-color ((((class color) (min-colors 89)) (:inherit term-color-white))))
 '(trailing-whitespace ((((class color) (min-colors 89)) (:background "#ff4242"))))
 '(web-mode-comment-face ((((class color) (min-colors 89)) (:foreground "#D9333F"))))
 '(web-mode-css-at-rule-face ((((class color) (min-colors 89)) (:foreground "#FF7F00"))))
 '(web-mode-css-pseudo-class-face ((((class color) (min-colors 89)) (:foreground "#FF7F00"))))
 '(web-mode-css-rule-face ((((class color) (min-colors 89)) (:foreground "#A0D8EF"))))
 '(web-mode-doctype-face ((((class color) (min-colors 89)) (:foreground "#82AE46"))))
 '(web-mode-html-attr-name-face ((((class color) (min-colors 89)) (:foreground "#C97586"))))
 '(web-mode-html-attr-value-face ((((class color) (min-colors 89)) (:foreground "#82AE46"))))
 '(web-mode-html-tag-face ((((class color) (min-colors 89)) (:foreground "#E6B422" :weight bold))))
 '(web-mode-server-comment-face ((((class color) (min-colors 89)) (:foreground "#D9333F")))))
