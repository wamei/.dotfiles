...
(when (require 'typescript nil t)
  ...
  (defvar ac-source-tss-yasnippet
    '((candidates . ac-yasnippet-candidates)
      ...
      (requires . 0)))
  (defun tss-setup-current-buffer:add-yasnippet-source ()
    (setq-local ac-sources (append '(ac-source-tss-yasnippet) ac-sources)))
  (advice-add 'tss-setup-current-buffer :after 'tss-setup-current-buffer:add-yasnippet-source)
